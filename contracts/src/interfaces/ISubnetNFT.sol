...
interface ISubnetNFT is IERC721 {
    ...
    function mint(address to, uint256 tokenId, string calldata name_, address subnetManager_, address alphaToken_, uint128 minStake_, string calldata skillsURI_) external;
