...
interface IAlphaTokenFactory {
    ...
    /// @notice Set the RootNet address and renounce ownership (one-time call)
    function setAddresses(address rootNet) external;
    /// @notice Deploy a new AlphaToken via CREATE2 (only RootNet may call)
