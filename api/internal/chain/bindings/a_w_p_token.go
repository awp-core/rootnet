...
// InitialMinted is a free data retrieval call binding the contract method 0xca1c4de9.
//
// Solidity: function initialMinted() view returns(bool)
func (_AWPToken *AWPTokenCaller) InitialMinted(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _AWPToken.contract.Call(opts, &out, "initialMinted")
...
//
// Solidity: function initialMinted() view returns(bool)
func (_AWPToken *AWPTokenSession) InitialMinted() (bool, error) {
	return _AWPToken.Contract.InitialMinted(&_AWPToken.CallOpts)
}

// InitialMinted is a free data retrieval call binding the contract method 0xca1c4de9.
//
// Solidity: function initialMinted() view returns(bool)
func (_AWPToken *AWPTokenCallerSession) InitialMinted() (bool, error) {
	return _AWPToken.Contract.InitialMinted(&_AWPToken.CallOpts)
}
...
// InitialMint is a paid mutator transaction binding the contract method 0x05a0ba7e.
//
// Solidity: function initialMint(uint256 amount) returns()
func (_AWPToken *AWPTokenTransactor) InitialMint(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _AWPToken.contract.Transact(opts, "initialMint", amount)
}

// InitialMint is a paid mutator transaction binding the contract method 0x05a0ba7e.
//
// Solidity: function initialMint(uint256 amount) returns()
func (_AWPToken *AWPTokenSession) InitialMint(amount *big.Int) (*types.Transaction, error) {
	return _AWPToken.Contract.InitialMint(&_AWPToken.TransactOpts, amount)
}

// InitialMint is a paid mutator transaction binding the contract method 0x05a0ba7e.
//
// Solidity: function initialMint(uint256 amount) returns()
func (_AWPToken *AWPTokenTransactorSession) InitialMint(amount *big.Int) (*types.Transaction, error) {
	return _AWPToken.Contract.InitialMint(&_AWPToken.TransactOpts, amount)
}
