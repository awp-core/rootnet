...
func (_StakeNFT *StakeNFTTransactor) RescueToken(opts *bind.TransactOpts, token common.Address, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakeNFT.contract.Transact(opts, "rescueToken", token, to, amount)
}

// RescueToken is a paid mutator transaction binding the contract method 0xe5711e8b.
//
// Solidity: function rescueToken(address token, address to, uint256 amount) returns()
func (_StakeNFT *StakeNFTSession) RescueToken(token common.Address, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakeNFT.Contract.RescueToken(&_StakeNFT.TransactOpts, token, to, amount)
}

// RescueToken is a paid mutator transaction binding the contract method 0xe5711e8b.
//
// Solidity: function rescueToken(address token, address to, uint256 amount) returns()
func (_StakeNFT *StakeNFTTransactorSession) RescueToken(token common.Address, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakeNFT.Contract.RescueToken(&_StakeNFT.TransactOpts, token, to, amount)
}
