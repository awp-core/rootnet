...
func (_StakeNFT *StakeNFTCaller) RootNet(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _StakeNFT.contract.Call(opts, &out, "rootNet")
...
//
// Solidity: function rootNet() view returns(address)
func (_StakeNFT *StakeNFTSession) RootNet() (common.Address, error) {
	return _StakeNFT.Contract.RootNet(&_StakeNFT.CallOpts)
}

// RootNet is a free data retrieval call binding the contract method 0x405a0b06.
//
// Solidity: function rootNet() view returns(address)
func (_StakeNFT *StakeNFTCallerSession) RootNet() (common.Address, error) {
	return _StakeNFT.Contract.RootNet(&_StakeNFT.CallOpts)
}
