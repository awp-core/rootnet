...
- **Staking**: deposit AWP into StakeNFT (ERC721 positions with lock period). `allocate(staker, agent, subnetId, amount)` — staker is explicit parameter. Auto-enumeration of agent worknets — no caller-supplied worknet list needed for freeze.
